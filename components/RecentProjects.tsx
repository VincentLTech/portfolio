        ...
        <div className="py-20">
            ...
            <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
                ...
                <div
                    ...
                    key={item.id}
                >
                    <PinContainer title="futurespace" href="https://twitter.com/mannupaaji">
                    ...
                    {/* <div className="flex items-center justify-between mt-7 mb-3">
                        ...
                        {item.iconLists.map((icon, index) => (
                            <div key={index} className="border border-white/[.2] rounded-full bg-black lg:w-10 lg:h-10 w-8 h-8 flex justify-center items-center" style={{transform: `translateX(-${5 * index + 2}px)`,}}>
